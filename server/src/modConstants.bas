...
' server-side stuff
Public Const ITEM_RESPAWN_RATE As Long = 300000 ' 5 mins
...
' Item despawn constants
Public Const ITEM_DESPAWN_PLAYER As Byte = 0
Public Const ITEM_DESPAWN_GLOBAL As Byte = 1
