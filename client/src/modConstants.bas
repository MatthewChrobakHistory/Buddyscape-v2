...
Public Const MAX_MAINBUTTONS As Long = 11
...
' Inventory constants
Public Const InvTop As Long = 17 ' 24
...
' spells constants
Public Const SpellTop As Long = 17 ' 24
...
Public Const VK_UP As Long = &H57
Public Const VK_DOWN As Long = &H53
Public Const VK_LEFT As Long = &H41
Public Const VK_RIGHT As Long = &H44
...
Public Const MAX_ANIMATIONS As Long = 100
Public Const MAX_SHOPS As Long = 200
...
Public Const MAX_SPELLS As Long = 100
...
Public Const MAX_PROJECTILES As Long = 100
Public Const MAX_BANK_TABS As Byte = 10
Public Const MAX_SHOP_ITEM_COSTS As Long = 4
...
' Map constants
Public Const MAX_MAPS As Long = 170
...
Public Const TILE_TYPE_CUSTOM As Byte = 15
Public Const TILE_TYPE_OBJECT As Byte = 16

' Item constants
Public Const ITEM_TYPE_NONE As Byte = 0
Public Const ITEM_TYPE_HELMET As Byte = 1
Public Const ITEM_TYPE_CAPE As Byte = 2
Public Const ITEM_TYPE_AMULET As Byte = 3
Public Const ITEM_TYPE_ARROWS As Byte = 4
Public Const ITEM_TYPE_WEAPON As Byte = 5
Public Const ITEM_TYPE_TORSO As Byte = 6
Public Const ITEM_TYPE_SHIELD As Byte = 7
Public Const ITEM_TYPE_LEGS As Byte = 8
Public Const ITEM_TYPE_GLOVES As Byte = 9
Public Const ITEM_TYPE_BOOTS As Byte = 10
Public Const ITEM_TYPE_RING As Byte = 11
Public Const ITEM_TYPE_CONSUME As Byte = 12
