...
Private Sub Form_Load()
    ...
    chkPass.BackColor = RGB(62, 61, 57)
    optFemale.BackColor = RGB(62, 61, 57)
    optMale.BackColor = RGB(62, 61, 57)
    
    txtCName.BackColor = RGB(33, 31, 29)
    txtLPass.BackColor = RGB(33, 31, 29)
    txtLUser.BackColor = RGB(33, 31, 29)
    txtRPass.BackColor = RGB(33, 31, 29)
    txtRPass2.BackColor = RGB(33, 31, 29)
    txtRUser.BackColor = RGB(33, 31, 29)
    
    txtCName.ForeColor = RGB(255, 255, 255)
    txtLPass.ForeColor = RGB(255, 255, 255)
    txtLUser.ForeColor = RGB(255, 255, 255)
    txtRPass.ForeColor = RGB(255, 255, 255)
    txtRPass2.ForeColor = RGB(255, 255, 255)
    txtRUser.ForeColor = RGB(255, 255, 255)
    
    txtCName.BorderStyle = 1
    txtLPass.BorderStyle = 1
    txtLUser.BorderStyle = 1
    txtRPass.BorderStyle = 1
    txtRPass2.BorderStyle = 1
    txtRUser.BorderStyle = 1
