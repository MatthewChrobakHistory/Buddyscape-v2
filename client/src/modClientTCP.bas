...
Public Sub SendAddChar(ByVal Name As String, ByVal Sex As Long, ByVal Sprite As Long)
Dim Buffer As clsBuffer
...
Public Sub BuyItem(ByVal ShopSlot As Long, ByVal Amount As Long)
Dim Buffer As clsBuffer
...
Public Sub SellItem(ByVal invslot As Long, ByVal Amount As Long)
Dim Buffer As clsBuffer
...
Dim Buffer As clsBuffer
    ...
    Buffer.WriteLong BankTab
    Buffer.WriteLong invslot
    Buffer.WriteLong BankMultiplier
    SendData Buffer.ToArray()
    Set Buffer = Nothing
...
Public Sub SendProgressConversation(ByVal Index As Long, ByVal Choice As Long)
Dim Buffer As clsBuffer

    Set Buffer = New clsBuffer
    Buffer.WriteLong CProgressConversation
    
    Buffer.WriteLong ConvNpc
    Buffer.WriteLong ConvState
...
Public Sub SendRequestJoinClan(ByVal Name As String)
Dim Buffer As clsBuffer

    Set Buffer = New clsBuffer
    Buffer.WriteLong CRequestJoinClan
    Buffer.WriteString Name
    SendData Buffer.ToArray()
    Set Buffer = Nothing
End Sub

Public Sub SendLeaveClan()
Dim Buffer As clsBuffer

    Set Buffer = New clsBuffer
    Buffer.WriteLong CLeaveClan
    SendData Buffer.ToArray()
    Set Buffer = Nothing
End Sub
