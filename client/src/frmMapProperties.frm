...
Begin VB.Form frmEditor_MapProperties 
   ...
   Begin VB.Frame fraMapSettings 
      ...
      Top             =   480
      Width           =   4215
      Begin VB.CheckBox chkLoseItems 
         Caption         =   "Lose Items?"
         Height          =   255
         Left            =   2760
         TabIndex        =   32
...
Private Sub chkLoseItems_Click()

    Map.LoseItemsOnDeath = chkLoseItems.Value
...
Private Sub Label3_Click()
    lblInstance.Caption = InputBox("0 - none | 1 - Player | 2 - Party")
    
    If lblInstance.Caption <> "0" And lblInstance.Caption <> "1" And lblInstance.Caption <> "3" Then
        lblInstance.Caption = "0"
    End If
End Sub

Private Sub lblInstance_Click()
