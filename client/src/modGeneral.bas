...
Public Sub Main()
    ...
    ReDim PaperdollOrder(1 To 7) As Long
    PaperdollOrder(1) = Equipment.Shield
    PaperdollOrder(2) = Equipment.Boots
    PaperdollOrder(3) = Equipment.Legs
    PaperdollOrder(4) = Equipment.Torso
    PaperdollOrder(5) = Equipment.Amulet
    PaperdollOrder(6) = Equipment.Cape
    PaperdollOrder(7) = Equipment.Helmet
...
Dim i As Long
    ...
    frmMain.picSpells.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\spells.jpg")
    frmMain.picOptions.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\options.jpg")
    frmMain.picClan.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\clan.jpg")
    frmMain.imgJoin.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\buttons\join_norm.jpg")
    frmMain.imgLeave.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\buttons\leave_norm.jpg")
    ...
    ' main - bars
    frmMain.imgHPBar.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bars\HP.jpg")
    frmMain.imgPRBar.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bars\PRAY.jpg")
    frmMain.imgSUMBar.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bars\SUMM.jpg")
    frmMain.picCombat.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\combat.jpg")
    frmMain.imgSpec.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bars\SPEC.jpg")
    frmMain.imgSpec_Void.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bars\SPEC_VOID.jpg")
    
    frmMain.imgSpellUp.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\buttons\spell_up.jpg")
    frmMain.imgSpellDown.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\buttons\spell_down.jpg")
    
    ' store the bar widths for calculations
    HPBar_Width = frmMain.imgHPBar.width
    SPRBar_Width = frmMain.imgPRBar.width
    EXPBar_Width = frmMain.imgSUMBar.width
        ...
        Case MENU_STATE_ADDCHAR
            ...
            If ConnectToServer(1) Then
                ...
                If frmMenu.optMale.Value Then
                    Call SendAddChar(frmMenu.txtCName, 1, newCharSprite)
                Else
                    Call SendAddChar(frmMenu.txtCName, 2, newCharSprite)
                End If
            End If
...
Dim Buffer As clsBuffer, i As Long
    ...
    frmMain.txtGlobalChat.Text = vbNullString
...
Public Sub SetFocusOnChat()
    ...
    If frmMain.txtMyChat.Visible Then
        frmMain.txtMyChat.SetFocus
    Else
        frmMain.txtUnfocus.SetFocus
    End If
End Sub
...
Public Sub cacheButtons()
    ...
    ' main - inv
    With MainButton(Tabs.TabInventory)
        .fileName = "inv"
        .state = 0 ' normal
    End With
    
    ' main - spells
    With MainButton(Tabs.TabSpells)
        .fileName = "spells"
        .state = 0 ' normal
    End With
    
    ' main - char
    With MainButton(Tabs.TabEquipment)
        .fileName = "char"
        .state = 0 ' normal
    End With
    
    ' main - opt
    With MainButton(Tabs.TabOptions)
        .fileName = "opt"
        .state = 0 ' normal
    End With
    
    ' main - trade
    With MainButton(Tabs.TabTrade)
        .fileName = "trade"
        .state = 0 ' normal
    End With
    
    ' main - clan
    With MainButton(Tabs.TabClan)
        .fileName = "clan"
        .state = 0 ' normal
    End With
    
    With MainButton(Tabs.TabSkills)
        .fileName = "skills"
        .state = 0
    End With
    
    With MainButton(Tabs.TabCombat)
        .fileName = "combat"
        .state = 0
    End With
    
    With MainButton(Tabs.TabFriends)
        .fileName = "friends"
        .state = 0
    End With
    
    With MainButton(Tabs.TabPrayer)
        .fileName = "prayer"
        .state = 0
    End With
    
    With MainButton(Tabs.TabQuests)
        .fileName = "quests"
        .state = 0
    End With
...
Dim bSuffix As String
    ...
    ' render the button
    If Not FileExist(MAINBUTTON_PATH + MainButton(buttonNum).fileName & bSuffix & ".jpg") Then Exit Sub
