...
Public SpellListColumn As Byte
Public SpellSlotNum As Long
...
Public ConvNpc As Long
Public InConv As Byte
Public ConvState As Long
Public BankTab As Byte
Public BankMultiplier As Long
Public CurrencyMenu As Byte
Public ShopMultiplier As Long
Public ShopItemSlot As Long
