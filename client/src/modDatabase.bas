...
Function GetPlayerLevel(ByVal Index As Long) As Long
    ...
    If Index > MAX_PLAYERS Then Exit Function
    GetPlayerLevel = Player(Index).CombatLevel
...
Sub SetPlayerLevel(ByVal Index As Long, ByVal Level As Long)
    ...
    If Index > MAX_PLAYERS Then Exit Sub
    Player(Index).CombatLevel = Level
...
Function GetPlayerEquipment(ByVal Index As Long, ByVal EquipmentSlot As Equipment) As Long
    ...
    If Index > MAX_PLAYERS Or EquipmentSlot = 0 Then Exit Function
...
Public Function GetCombatName(ByVal Combat As Long) As String
    Select Case Combat
        Case CombatStyles.Melee
            GetCombatName = "Melee"
        Case CombatStyles.Ranged
            GetCombatName = "Ranged"
        Case CombatStyles.Magic
            GetCombatName = "Magic"
    End Select
End Function
